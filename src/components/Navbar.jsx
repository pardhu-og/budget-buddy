...
export default function Navbar(){
    ...
    return (
        <nav>
            ...
            <div className={`fixed top-0 left-1/2 translate-x-[-50%] translate-y-[-100%] w-40 h-10 md:w-48 md:h-15 lg:w-52 lg:px-2 bg-gray-200 flex justify-center items-center border rounded-xl text-green-700 text-sm md:text-base lg:text-lg font-bold opacity-0  ${sampleanimation!== 0?"animate-slidein":""} caret-transparent
                            `} >
