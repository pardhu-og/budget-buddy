    ...
    return (
        <div className=" flex flex-col  m-1 p-1  shadow-xl gap-2  border border-gray-400 shadow rounded-lg
            ...
            <h2 className="text-center text-base p-1 italic font-semibold
                            md:p-3 md:text-lg 
                            lg:p-4 lg:text-2xl">Transaction details</h2>
            ...
            <div className="flex gap-6 justify-center">
               ...
               <label htmlFor="income" className=" p-1 px-2  rounded-lg peer-checked:bg-red-400 peer-checked:text-white peer-checked:font-semibold border shadow-sm">Income</label>
               </div>
              <div>
              ...
              <label htmlFor="amount" className="p-1 ">Amount:</label>
               <input type="number" id="amount" name="amount" value={inpvalidationState.amount} onChange={handleChange}
                      className="border border-gray-400 rounded-lg w-40 text-right  p-1
                                  "/>  
              </div> 
